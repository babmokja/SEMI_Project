...
/**
 * Servlet implementation class OwneBoardReplySearchCommentListServlet
 */
@WebServlet("/owner/searchreplycomment")
public class OwneBoardReplySearchCommentListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalCount = ownerService.selectReviewReplyTotalCount(condition,value);
