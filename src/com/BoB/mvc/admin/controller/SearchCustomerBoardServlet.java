...
/**
 * Servlet implementation class SearchCustomerBoardServlet
 */
@WebServlet("/admin/customer/board/search")
public class SearchCustomerBoardServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalCount = adminService.searchCusBoardCount(condition, value);
		...
		List<CustomerBoardDTO> boardList = adminService.searchCusBoardList(condition, value, pageInfo);
