	...
	<div class="header">
        ...
        <div class="wrap">
            <div class="main_menu">
                ...
                <li><a href="${ pageContext.servletContext.contextPath }/owner/modify"><img src="${ pageContext.servletContext.contextPath }/resources/image/owner/semi_store/내정보관리.png" alt="내정보관리">내 정보관리</a></li>
