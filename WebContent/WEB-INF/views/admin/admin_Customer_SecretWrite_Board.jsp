...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="resources/css/admin/admin_Customer_SecretWrite_Board.css">
...
<body>
    ...
    <aside class="aside">
        ...
        <div class="aside_top">고객 비밀건의 게시글 </div>
    </aside>
          ...
          <div class="gap">
            <div class="content">
              ...
              <form action="#" name="asd" method="get" class="clearfix">
                ...
                <button><a href="admin_Customer_Secret_Board.html">댓글 작성</a></button>
              </form>
