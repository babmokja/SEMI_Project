...
<body>
        ...
        <div class="wrap">
            <div class="main_menu">
                <li><a href="#"><img src="resources/image/admin/주문확인.png" alt="주문확인">주문확인</a></li>
                <li><a href="#"><img src="resources/image/admin/고객관리.png" alt="고객관리">고객관리</a></li>
                <li><a href="#"><img src="resources/image/admin/내정보관리.png" alt="내정보관리">업소관리</a></li>
                <li><a href="#"><img src="resources/image/admin/리뷰관리.png" alt="리뷰관리">게시판</a></li>
            </div>
