...
<body>
                ...
                <tbody>
				 <c:forEach var="board" items="${ requestScope.boardList }">
					...
					<tr>
                        ...
                        <td class="section_contest_first section_contest_3"><a href="${pageContext.servletContext.contextPath}/admin/customer/comment?boardCode=${ board.boardCode }">aaa</a></td>
    ...
    <footer>
        ...
        <script>
		const link = "${ pageContext.servletContext.contextPath }/admin/customer/board";
		const searchLink = "${ pageContext.servletContext.contextPath }/admin/customer/board/search";
